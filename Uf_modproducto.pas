...
var
  f_modproductos: Tf_modproductos;
  hubo_error:boolean;
...
function Tf_modproductos.Escod_productoUnico(cod:string):boolean;
var
   res:boolean  ;
begin
...
function Tf_modproductos.formulario_valido:boolean;
var
   errores:string;
begin
     errores:='';
...
function Tf_modproductos.obtener_idPrinAC(p_nombre:string):integer;
begin
    with ob_idsPRIN do
    begin
...
function Tf_modproductos.obtener_idACC(p_nombre:string):string;
begin
    with ob_idsACC do
    begin
      Params[0].AsString:=p_nombre;
...
procedure Tf_modproductos.guardar_formulario;
var
   k:integer;
...
procedure Tf_modproductos.limpiar_formulario;
begin
...
procedure Tf_modproductos.B_sel_prinClick(Sender: TObject);
var
  id_accion:integer;
begin
...
procedure Tf_modproductos.b_eliminarClick(Sender: TObject);
begin
...
procedure Tf_modproductos.List_PrincipioEnter(Sender: TObject);
begin
...
procedure Tf_modproductos.B_sel_terClick(Sender: TObject);
var
  lid_acc:string;
begin
...
procedure Tf_modproductos.b_elim_terClick(Sender: TObject);
begin
...
procedure Tf_modproductos.FormShow(Sender: TObject);
begin
    ed_id.SetFocus;
end;

procedure Tf_modproductos.b_cancelarClick(Sender: TObject);
begin
...
procedure Tf_modproductos.b_guardar_continuarClick(Sender: TObject);
begin
hubo_error:=true;
...
//    m_datos.Transaccion.StartTransaction;
    ...
    hubo_error:=false;
      ...
      begin
         ...
         m_datos.Producto.CancelUpdates;
...
procedure Tf_modproductos.b_guardarcerrarClick(Sender: TObject);
begin
